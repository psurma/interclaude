...
- Web UI: Collapsed sidebar now shows instance name and status on hover (e.g., "backend-dev (online)")

## [0.0.61] - 2024-12-12

### Added

- Server startup now logs the Claude working directory (CLAUDE_WORKING_DIR)

## [0.0.60] - 2024-12-12

### Added

- Web UI: Instance details panel now shows package context info (packages discovered, packages with docs)
...
- Web UI: Collapse arrow now points inward when expanded, down when collapsed
