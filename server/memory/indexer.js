...
const STOP_WORDS = new Set([
  ...
  'can', 'could', 'do', 'does', 'did', 'how', 'what', 'when', 'where',
  'which', 'who', 'why', 'this', 'these', 'those', 'i', 'you', 'we',
  'they', 'my', 'your', 'our', 'their', 'me', 'him', 'her', 'us', 'them',
  'if', 'then', 'else', 'but', 'not', 'no', 'yes', 'so', 'just',
  'more', 'most', 'some', 'any', 'all', 'also', 'than', 'only',
  'very', 'too', 'now', 'here', 'there', 'up', 'down', 'out', 'about',
  'into', 'over', 'after', 'before', 'between', 'under', 'again',
  'should', 'need', 'want', 'like', 'get', 'make', 'know', 'think',
  'see', 'use', 'used', 'using', 'way', 'work', 'working', 'thing',
  'please', 'thanks', 'thank', 'help', 'question', 'answer', 'example'
]);

// Topic categories with associated keywords
const TOPIC_KEYWORDS = {
  'security': ['auth', 'authentication', 'authorization', 'jwt', 'token', 'oauth', 'password', 'encrypt', 'hash', 'ssl', 'tls', 'https', 'api-key', 'secret', 'credential', 'permission', 'role', 'session', 'cookie'],
  'api-design': ['api', 'rest', 'graphql', 'endpoint', 'request', 'response', 'http', 'get', 'post', 'put', 'delete', 'patch', 'route', 'path', 'query', 'parameter', 'header', 'body', 'status', 'swagger', 'openapi'],
  'database': ['database', 'db', 'sql', 'nosql', 'query', 'table', 'schema', 'index', 'migration', 'postgres', 'mysql', 'mongodb', 'redis', 'sqlite', 'orm', 'model', 'relation', 'join', 'transaction'],
  'frontend': ['react', 'vue', 'angular', 'svelte', 'html', 'css', 'javascript', 'typescript', 'component', 'state', 'props', 'hook', 'dom', 'browser', 'ui', 'ux', 'style', 'responsive', 'mobile'],
  'backend': ['server', 'node', 'express', 'fastify', 'middleware', 'handler', 'controller', 'service', 'repository', 'microservice', 'monolith', 'lambda', 'serverless', 'docker', 'kubernetes'],
  'testing': ['test', 'unit', 'integration', 'e2e', 'jest', 'mocha', 'cypress', 'playwright', 'mock', 'stub', 'fixture', 'assertion', 'coverage', 'tdd', 'bdd'],
  'devops': ['deploy', 'ci', 'cd', 'pipeline', 'build', 'release', 'docker', 'container', 'kubernetes', 'k8s', 'aws', 'gcp', 'azure', 'terraform', 'ansible', 'monitoring', 'logging'],
  'performance': ['performance', 'optimize', 'cache', 'speed', 'latency', 'throughput', 'memory', 'cpu', 'profiling', 'benchmark', 'load', 'scale', 'concurrent'],
  'architecture': ['architecture', 'design', 'pattern', 'mvc', 'mvvm', 'clean', 'hexagonal', 'domain', 'layer', 'module', 'dependency', 'injection', 'solid', 'dry', 'kiss'],
  'error-handling': ['error', 'exception', 'catch', 'throw', 'try', 'finally', 'debug', 'log', 'trace', 'stack', 'bug', 'fix', 'issue', 'problem']
};
